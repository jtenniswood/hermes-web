...
export const BackendVersionTarget = createContext<HTMLElement | null>(null)
...
export function StatusbarControls(props: ComponentProps<typeof DesktopStatusbar>) {
  ...
  const versionTarget = useContext(BackendVersionTarget)
  ...
  return <>
    {versionTarget && backendVersion && createPortal(<StatusbarItemView item={backendVersion} navigate={navigate} />, versionTarget)}
